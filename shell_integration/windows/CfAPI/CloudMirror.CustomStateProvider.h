#pragma once
#include "CloudMirror/CustomStateProvider.g.h"
...
namespace winrt::CloudMirror::implementation
{
    struct CustomStateProvider : CustomStateProviderT<CustomStateProvider>
    {
        ...
        winrt::Windows::Foundation::Collections::IIterable<winrt::Windows::Storage::Provider::StorageProviderItemProperty> GetItemProperties(hstring const& itemPath);
    };
}
