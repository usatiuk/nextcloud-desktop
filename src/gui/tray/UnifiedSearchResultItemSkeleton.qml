...
RowLayout {
    ...
    */
    ...
    // On init we often have the column return a width of 0 due to layouts not being fully done.
    // We set a placeholder value to at least have the animation work correctly even if widths
    // are not yet available.
    property int animationStartX: width === 0 ? -Style.trayWindowWidth : -width
    property int animationEndX: width === 0 ? Style.trayWindowWidth : width
    property int animationRectangleWidth: width === 0 ? Style.trayWindowWidth : width
