...
NEXTCLOUD_CFAPI_EXPORT Result<OCC::Vfs::ConvertToPlaceholderResult, QString> convertToPlaceholder(const QString &filename, time_t modtime, qint64 size, const QByteArray &fileId, const QString &replacesPath);
