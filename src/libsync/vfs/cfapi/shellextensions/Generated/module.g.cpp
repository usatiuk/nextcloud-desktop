...
void* __stdcall winrt_get_activation_factory([[maybe_unused]] std::wstring_view const& name)
{
    ...
    if (requal(name, L"CfApiShellExtensions.CustomStateProvider"))
    {
        return winrt::detach_abi(winrt::make<winrt::CfApiShellExtensions::factory_implementation::CustomStateProvider>());
    }
